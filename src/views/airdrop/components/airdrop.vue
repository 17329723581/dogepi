	...
	<div class="warp">
		<div class="pc">
			<a-row type="flex" class="banner" justify="space-between">
				<a-col :md="10" :xs="24" class="presale-left">
					<h1>
						<span>{{ this.$t("a_text1") }}</span> {{ this.$t("a_text2") }}
					</h1>
					<h1>{{ this.$t("a_text3") }}</h1>
					<h2>
						{{ this.$t("a_text4") }}
					</h2>
			...
			<a-row type="flex" justify="space-between">
				<a-col :md="24" :xs="24" class="presale-left">
					...
					<div class="timecom">
						...
						<div class="btn">{{ this.$t("a_time_btn1") }}</div>
					...
					<div class="invite">
						...
						<img class="img" src="@/assets/car1.png" />
					</div>
					<div class="rules">
		...
		<div class="mobile">
			...
			<div class="timecom">
				...
				<div class="btn">{{ this.$t("a_time_btn1") }}</div>
				<div class="des" style="font-weight: bold;font-size: 1.25rem;">{{ storeInviteLink[0] }}</div>
				<div class="btn" v-clipboard:copy="storeInviteLink[0]" v-clipboard:success="onCopy">
					{{ this.$t("a_time_btn2") }}</div>
				<div class="des" style="font-weight: bold;font-size: 1.25rem;">{{ this.$t("a_m_time_msg") }}</div>
			</div>
